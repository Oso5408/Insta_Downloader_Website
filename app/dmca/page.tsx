...
export default function DmcaPolicy() {
  return (
    <div className="max-w-2xl mx-auto py-12 px-4">
      <h1 className="text-3xl font-bold mb-6 text-center">DMCA Policy</h1>
      <div className="space-y-4 text-gray-700">
        <p className="italic">Last updated: 24-6-2025</p>
        <p>InstaDownloader respects the intellectual property rights of others and complies with the Digital Millennium Copyright Act (DMCA).</p>
        <h2 className="text-xl font-semibold mt-6">1. Reporting Copyright Infringement</h2>
        <p>If you believe that content on our website infringes your copyright, please send a written notice to our designated DMCA agent with the following information:</p>

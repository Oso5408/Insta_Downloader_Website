  ...
  return (
    <div className="max-w-2xl mx-auto py-12 px-4">
      ...
      <div className="space-y-4 text-gray-700">
        ...
        <p>This Cookie Policy explains how InstaDownloader uses cookies and similar technologies.</p>
        ...
        <p>You can control or disable cookies through your browser settings. However, some features may not function properly without cookies.</p>
